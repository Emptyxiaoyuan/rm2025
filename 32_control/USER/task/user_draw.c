...
{
	uint8_t i=0;
	draw_rc=get_remote_control_point();
  ...
  while (1)
  {
    ...
    //send_Draw_Data((uint8_t *)&ui_default_Ungroup_line1, sizeof(ui_default_Ungroup_line1));
...
ui_interface_line_t *ui_1_Ungroup_NewLine1 = (ui_interface_line_t *)&(ui_1_Ungroup_0.data[0]);
ui_interface_line_t *ui_1_Ungroup_NewLine2 = (ui_interface_line_t *)&(ui_1_Ungroup_0.data[1]);
ui_interface_line_t *ui_1_Ungroup_NewLine3 = (ui_interface_line_t *)&(ui_1_Ungroup_0.data[2]);
ui_interface_line_t *ui_1_Ungroup_NewLine4 = (ui_interface_line_t *)&(ui_1_Ungroup_0.data[3]);
ui_interface_number_t *ui_1_Ungroup_NewNumber = (ui_interface_number_t *)&(ui_1_Ungroup_0.data[4]);
...
void _ui_init_1_Ungroup_0() {
    ...
    ui_1_Ungroup_NewLine1->figure_tpye = 0;
    ui_1_Ungroup_NewLine1->layer = 0;
    ui_1_Ungroup_NewLine1->start_x = 863;
    ui_1_Ungroup_NewLine1->start_y = 462;
    ui_1_Ungroup_NewLine1->end_x = 1063;
    ui_1_Ungroup_NewLine1->end_y = 462;
    ui_1_Ungroup_NewLine1->color = 1;
    ui_1_Ungroup_NewLine1->width = 2;

    ui_1_Ungroup_NewLine2->figure_tpye = 0;
    ui_1_Ungroup_NewLine2->layer = 0;
    ui_1_Ungroup_NewLine2->start_x = 960;
    ui_1_Ungroup_NewLine2->start_y = 405;
    ui_1_Ungroup_NewLine2->end_x = 960;
    ui_1_Ungroup_NewLine2->end_y = 515;
    ui_1_Ungroup_NewLine2->color = 1;
    ui_1_Ungroup_NewLine2->width = 2;



    CAT(ui_proc_, CAT(FRAME_OBJ_NUM, _frame))(&ui_1_Ungroup_0);
    usart6_tx_dma_enable((uint8_t *) &ui_1_Ungroup_0, sizeof(ui_1_Ungroup_0));
}
...
void _ui_update_1_Ungroup_0() {
    for (int i = 0; i < OBJ_NUM; i++) {
		...
		ui_1_Ungroup_NewNumber->number = key_content.shell_cover;
