...
ext_event_data_t field_event;                              // 产地事件数据
...
ext_game_robot_state_t robot_state;		// 机器人当前等级，经验，功率上限，热量上限等数据
...
/**
 * @brief Get the shoot heat0 limit and heat0 object
 *
 * @param heat0_limit 获取射速限制
 * @param heat0 热量
 */
 ...
 * @param power
 */
void get_chassis_power_max(uint16_t *power)
{
